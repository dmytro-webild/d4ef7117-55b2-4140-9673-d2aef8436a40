...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      slides={[
        ...
        },
        {
          ...
          imageAlt: "Modern reception counter with classy interior design",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/elderly-guest-arrives-hotel-lobby_482257-81592.jpg",
          imageAlt: "Elderly guest arrives in hotel lobby",
        },
        {
        ...
        },
        {
          ...
          imageAlt: "Cheerful women taking pictures in cafe",
        },
      ]}
    />
  </div>
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Taglio",
          description: "Precisione, stile e armonia con il tuo viso.",
      ...
      faqs={[
        {
          id: "f1",
          title: "Quanto costa?",
          content: "I prezzi vengono sempre spiegati prima. Trasparenza totale.",
        },
        {
          id: "f2",
          title: "E se non so cosa voglio?",
          content: "Ti aiutiamo noi: è il nostro lavoro.",
        },
        {
          id: "f3",
          title: "Potete sistemare un taglio o colore sbagliato?",
          content: "Sì, lavoriamo spesso su correzioni.",
        },
        {
          id: "f4",
          title: "È adatto a tutte le età?",
          content: "Assolutamente sì.",
        },
      ]}
